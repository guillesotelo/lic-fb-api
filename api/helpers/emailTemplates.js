...
`
const purchaseEntrenamientoEmail = (data, fullName) => `
<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<head>
<!--[if gte mso 9]>
...
<a style="text-decoration: none; border: none; padding: .7rem; border-radius: .3rem; background-color: #b0bcebad" href='https://api.whatsapp.com/send/?phone=34650609282&text=Hola+Angelita%2C%0A%0AHe+reservado+el+servicio+de+Entrenamiento+Diario+Personal+contigo+y+me+gustaría+coordinar+nuestro+primer+encuentro.%0A%0AEl ID de mi reserva es: ${data._id ? data._id.substring(18) : '(sin ID)'}%0A%0AGracias.%0A&type=phone_number&app_absent=0'>Coordinar encuentro</a>
      </td>
    </tr>
  </tbody>
</table>
